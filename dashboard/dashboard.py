...
if 'customer_unique_id' in geolocation.columns:
    ...
    print("Column 'customer_unique_id' does not exist.")
    data = geolocation  # Handle accordingly
...
sns.barplot(x=review_score.index,
            ...
            palette=["#068DA9" if score ==
                     common_score else "#D3D3D3" for score in review_score.index]
            )
...
with tab1:
    ...
    sns.barplot(x=state.customer_state.value_counts().index,
                ...
                data=state,
                palette=["#068DA9" if score ==
                         most_common_state else "#D3D3D3" for score in state.customer_state.value_counts().index]
                )
